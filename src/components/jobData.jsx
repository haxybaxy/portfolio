export const jobData = [
  ...
  {
    value: "tab4",
    company: "IEU Tech Lab",
    role: "Project Intern",
    startDate: "January 2024",
    endDate: "June 2024",
    content: [
      "Developed AI transcription tools, proposed AI-driven meeting optimization strategies, and created investor relation CRM integration plan for Banco Santander.",
  ...
  {
    value: "tab6",
    company: "Dynamics Innovations",
    role: "Software Engineering Intern",
    startDate: "July 2024",
    endDate: "September 2024",
    content: [
      "Developed and deployed CRM and ERP systems across the MENA region, ensuring seamless integration and functionality, using various cross platform web and mobile technologies.",
      "Managed Azure cloud resources to support scalable and secure infrastructure for ERP and CRM systems.",
